...
namespace CapaVista
{
    public partial class Combo : UserControl
    {
        ...
        public void llenarse(string tabla, string campo1, string campo2)
        {
            ...
            Cbo_Auto.AutoCompleteCustomSource = coleccion;
            Cbo_Auto.AutoCompleteMode = AutoCompleteMode.SuggestAppend;
            Cbo_Auto.AutoCompleteSource = AutoCompleteSource.CustomSource;
